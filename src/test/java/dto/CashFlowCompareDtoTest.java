...
/**
 * Test class για την CashFlowCompareDto.
 */
public class CashFlowCompareDtoTest {

  @Test
    public void testToStringBothYearsAvailable() {
  ...
  @Test
    public void testToStringMissingInYear1() {
  ...
  @Test
    public void testToStringMissingInYear2() {
