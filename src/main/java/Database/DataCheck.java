...
public class DataCheck {
    ...
    private static void insertForeisFromCsv(String filename) throws Exception {
        try (InputStream is = DataImporter.class.getResourceAsStream("/data/" + filename)) {
            ...
            try (Connection conn = DriverManager.getConnection(URL);
                 ...
                 Scanner scanner = new Scanner(is, "ISO-8859-7")) { // εδώ ορίζουμε τη σωστή κωδικοποίηση
    ...
    private static void insertCashflowsFromCsv(String filename, String type) throws Exception {
        try (InputStream is = DataImporter.class.getResourceAsStream("/data/" + filename)) {
            ...
            try (Connection conn = DriverManager.getConnection(URL);
                 ...
                 Scanner scanner = new Scanner(is, "ISO-8859-7")) { // πάλι σωστή κωδικοποίηση
