...
public class MainFrame extends JFrame { 
  ...
  private MainFrame() {
    ...
    try {
      tempLogo = toBufferedImage(new ImageIcon("src/main/resources/GoverLensLogo.jpg").getImage());
      tempBackground = toBufferedImage(new ImageIcon("src/main/resources/BackroundPhoto.jpg")
      .getImage());
    } catch (Exception e) {
  ...
  @edu.umd.cs.findbugs.annotations.SuppressFBWarnings(value = "MS_EXPOSE_REP",
      justification = "Singleton instance access is intentional")
  ...
  public void showFinanceChart() {
    if (selectedYear == null) {
      JOptionPane.showMessageDialog(this, "Πρέπει να επιλέξετε πρώτα έτος.",
