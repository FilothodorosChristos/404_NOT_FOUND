...
3. **Λειτουργίες**:
   ...
   - **Μαζικές** **αλλαγές**:Αυτή η λειτουργία σου επιτρέπει να εφαρμόσεις ποσοστιαίες μεταβολές σε ολόκληρες κατηγορίες του προϋπολογισμού με ένα κλικ.Έτσι,επιτυγχάνεται η εξοικονόμηση χρόνου καθώς και προωθείται η ανάπτυξη στρατηγικών εύκολα και γρήγορα
