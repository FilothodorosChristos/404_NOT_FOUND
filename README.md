...
3. **Λειτουργίες**:
   ...
   - Η εφαρμογή παρέχει τη δυνατότητα εξαγωγής των οικονομικών καταστάσεων της επιλογής του χρήστη σε μορφή PDF, αποθηκεύοντάς τες απευθείας στον υπολογιστή του. Με αυτόν τον τρόπο διευκολύνεται η αρχειοθέτηση, η εκτύπωση και η περαιτέρω αξιοποίηση των αναφορών.
