...
## Τενολογικό Οικοσύστημα

Η υλοποίηση της εργασίας απαιτούσε τη χρήση διαφόρων εργαλείων , εκ των οποίων τα βασικότερα αναφέρονται στο :
**git**
**github**
**eclipse**
**Virtual Studio** 
 με σκόπο τη διαχείρηση των δεδομένων,την εκτέλεση/υλοποίηση του απαιτούμενου κώδικα  και την αποτελεσματική επικοινωνία μεταξύ των μελών της ομάδας 

**“Maven” (για τη διαχείρηση του κύκλου ζωής του project μας )**
**"CLOC”( για τη δυνατότητα καταμέτρησης των γραμμών στον κώδικα )**
**”Spotbugs”,”Checkstyle”,”Jacoco”,”Junit”(τα οποία είναι απαραίτητα για τον έλεγχο του κώδικα και τον εντοπισμό πιθανόν σφαλμάτων και την εξασφάλιση  ποιοτικών κλάσεων )**
**”PlantUml”,”Canva”(με σκοπό τη δημιουργία παρουσιάσεων και την απεικόνιση των σχέσεων που δημιουργήθηκαν μεταξύ των κλάσεων που απαρτίζουν την εφαρμογή μας)**
**”SQLite” , “excel”(για την αποθήκευση δεδομένων αναφορικά με τους σχετικούς κρατικούς προϋπολογισμούς  ,καθώς και την οργάνωση της πληροφορίας )**
**”ChatGpt”,”Gemini”,”Claude(εργαλεία τεχνητής νοημοσύνης για καθοδήγηση σε πιθανά εμπόδια)**
**“teams”  για την επικοινωνία και ανατροφοδότηση μεταξύ των εμπλεκόμενων στο εγχείρημα “GoverLens”**
